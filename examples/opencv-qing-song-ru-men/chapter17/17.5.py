...
count, markers1 = cv.connectedComponents(img_fg)
markers2 = markers1 + 1
markers2[img_unknown == 255] = 0

plt.subplot(121), plt.imshow(markers1, cmap='gray'), plt.title('markers1'), plt.axis('off')
plt.subplot(122), plt.imshow(markers2, cmap='gray'), plt.title('markers2'), plt.axis('off')
plt.show()
