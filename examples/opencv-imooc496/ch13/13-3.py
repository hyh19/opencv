...
car_plate_classifier = cv.CascadeClassifier('haarcascades/haarcascade_russian_plate_number.xml')
car_plates = car_plate_classifier.detectMultiScale(gray, 1.1, 3)
